...
namespace Reflection
{
    ...
    public class ShaderTutorial : Microsoft.Xna.Framework.Game
    {
        ...
        {
            Window.Title = "Shader programming :: Tutorial 15 - Dynamic Cube reflection";
        ...
        protected override void Initialize()
        {
            ...
            RefCubeMap = new RenderTargetCube(GraphicsDevice, 256, true, GraphicsDevice.DisplayMode.Format, DepthFormat.Depth16);
            EnvironmentMap = new TextureCube(GraphicsDevice, 256, true, GraphicsDevice.DisplayMode.Format);
        ...
        protected override void LoadContent()
        {
            ...
            renderTarget = new RenderTarget2D(GraphicsDevice, pp.BackBufferWidth, pp.BackBufferHeight, true,
                SurfaceFormat.Color, DepthFormat.Depth24Stencil8, pp.MultiSampleCount, RenderTargetUsage.DiscardContents);

            BGRenderTarget = new RenderTarget2D(GraphicsDevice, pp.BackBufferWidth, pp.BackBufferHeight, true,
                SurfaceFormat.Color, DepthFormat.Depth24Stencil8, pp.MultiSampleCount, RenderTargetUsage.DiscardContents);

            depthRT = new RenderTarget2D(GraphicsDevice, pp.BackBufferWidth, pp.BackBufferHeight, true,
                SurfaceFormat.Single, DepthFormat.Depth24Stencil8, pp.MultiSampleCount, RenderTargetUsage.DiscardContents);
            depthRT2 = new RenderTarget2D(GraphicsDevice, pp.BackBufferWidth, pp.BackBufferHeight, true,
                SurfaceFormat.Single, DepthFormat.Depth24Stencil8, pp.MultiSampleCount, RenderTargetUsage.DiscardContents);
        ...
        protected override void Draw(GameTime gameTime)
        {
            ...
            graphics.GraphicsDevice.SetRenderTarget(BGRenderTarget);
            ...
            BackGroundRenderTexture = BGRenderTarget;
            ...
            spriteBatch.Begin(SpriteSortMode.Immediate, BlendState.Opaque);
            {
                ...
                //effectPost.Begin();
                {
                    effectPost.CurrentTechnique.Passes[0].Apply();
                    {
                        ...
                        effectPost.Parameters["BGScene"].SetValue(BackGroundRenderTexture);
